    ...
    public partial class InitialDatabaseCreation : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.BusinessUnits", t => t.BusinessUnitsId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Departments", "BusinessUnitsId", "dbo.BusinessUnits");
            ...
            DropIndex("dbo.Departments", new[] { "BusinessUnitsId" });
